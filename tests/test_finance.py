...
class FinanceTests(unittest.TestCase):
    ...
    def test_calendar_periods_and_cross_midnight_income(self):
        ...
        self.assertEqual((yesterday['spent_minor'], yesterday['earned_minor']), (1025, 0))
        self.assertEqual((today['spent_minor'], today['earned_minor']), (0, 2000))
        self.assertEqual(today['items'][0]['spent_minor'], 1025)
